"""
客户全部产品专区下单流程测试（验证 select_first_product 方法）
...
@pytest.mark.order(5)
def test_customer_all_products_select_first(page):
    """客户全部产品专区下单全流程（使用 CartPage.select_first_product）"""
    ...
    # ====== 替换：CartPage.select_first_product() 勾选第一个复选框 ======
    CartPage(page2).select_first_product()
